...
class AdminService {
  ...
  Future<void> deleteVideo(String id) async {
      await _firestore.collection('content').doc('videos').collection('items').doc(id).delete();
  }
  ...
  Future<void> deleteContent(String collection, String id) async {
     await _firestore.collection('content').doc(collection).collection('items').doc(id).delete();
  }

  Future<void> updateContentStatus(
      String type, String id, String status, bool isActive) async {
