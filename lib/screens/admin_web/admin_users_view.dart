                    ...
                    child: Container(
                      ...
                      child: DataTable(
                        ...
                        columns: const [
                          ...
                          DataColumn(label: Align(alignment: Alignment.centerRight, child: Text('Hành động'))),
                        ],
          ...
          Row(
            children: [
              CircleAvatar(
                ...
                child: Icon(Icons.person, color: _getRoleColor(user.role), size: 18),
              ),
              ...
              children: [
                ...
                const SizedBox(height: 16),
                 ...
                 DropdownButtonFormField<String>(
                   ...
                   items: const [
                     DropdownMenuItem(value: 'active', child: Text('Active (Hoạt động)')),
                     DropdownMenuItem(value: 'banned', child: Text('Banned (Bị khóa)')),
                   ],
  ...
  void _showDeleteConfirmDialog(BuildContext context, UserModel user) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Bạn có chắc chắn muốn xóa vĩnh viễn người dùng "${user.name}" không?\nHành động này không thể hoàn tác.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context), 
            child: const Text('Hủy')
          ...
          ElevatedButton(
            ...
            onPressed: () async {
               ...
               Navigator.pop(context);
               ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Đã xóa người dùng'), backgroundColor: Colors.orange)
               );
            },
